      ...
      <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "20px" }}>
        ...
        <tbody>
          <tr>
            ...
            <td style={{ padding: "10px", border: "1px solid #ddd" }}>{meetingData.date}</td>
            <td style={{ padding: "10px", border: "1px solid #ddd" }}>{meetingData.company}</td>
            <td style={{ padding: "10px", border: "1px solid #ddd" }}>{meetingData.department}</td>
            <td style={{ padding: "10px", border: "1px solid #ddd" }}>{meetingData.position}</td>
            <td style={{ padding: "10px", border: "1px solid #ddd" }}>{meetingData.representative}</td>
            ...
            <td style={{ padding: "10px", border: "1px solid #ddd" }}>{meetingData.survey1}</td>
            <td style={{ padding: "10px", border: "1px solid #ddd" }}>{meetingData.survey2}</td>
          </tr>
        </tbody>
      </table>
